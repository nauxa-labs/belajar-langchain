...
const curriculum = [
  ...
  },
  {
    status: '✅',
    title: 'RAG',
    description: 'Retrieval Augmented Generation, vector stores',
    link: '/docs/rag/konsep-rag',
  },
  {
    status: '✅',
    title: 'Memory & Conversation',
    description: 'Chatbot dengan memori percakapan',
    link: '/docs/memory/konsep-memory',
  },
  {
    status: '✅',
    title: 'Agents & Tools',
    description: 'Function calling, tool use, ReAct pattern',
    link: '/docs/agents/konsep-agents',
  },
  {
    status: '✅',
    title: 'LangGraph',
    description: 'State management, multi-agent workflows',
    link: '/docs/langgraph/intro',
  },
  {
    status: '✅',
    title: 'Production',
    description: 'LangSmith, LangServe, deployment',
    link: '/docs/production/langsmith-setup',
  },
  {
    status: '✅',
    title: 'Proyek Praktis',
    description: '4 hands-on projects',
